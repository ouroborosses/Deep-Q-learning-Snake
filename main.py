...
from qlearning_snake import IA_qlearning
from Astar_snake import IA_Astar
from dna import Dna
from QLEARNING_snake_genetic import Snake_q
...
def main():
    ...
    group_algorithm.add_argument(
        ...
        "--nnqlearning",
        action="store_true",
        help="QLearning algorithm: plays a move based of trained neural network",
    )
    group_algorithm.add_argument(
        "-q",
        "--qlearning",
        action="store_true",
        help="Q-learning algorithm: plays a move based on a trained neural network using Q-learning, please select weight file",
    )
    group_algorithm.add_argument(
        "-s",
        "--sshaped",
    ...
    if args.player:
        ...
        if args.astar or args.sshaped:
            ...
            agent = IA_qlearning(args, game)
        elif args.nnqlearning:
            agent = Snake_q(game)
